...
```
git clone https://github.com/aaronvera23/react-auth-server.git
...
### Client
Please follow the instructions [for setting up the client repo](https://github.com/aaronvera23/react-auth-client).

### Issues
Something not working?  Please [open an issue](https://github.com/aaronvera23/react-auth-server/issues) or submit a PR.